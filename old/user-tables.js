//TODO add functionality for users to have their own api sections?
module.exports = function (table, columns) {
  ...
  router.post('/', function(req, res, next) {
    db.run(SQLPostStatement, columns.map(function(column) {
  ...
  router.put('/:id', function(req, res, next) {
    var columnData = columns.map(function(column) {
      return req.body[column]
    });
